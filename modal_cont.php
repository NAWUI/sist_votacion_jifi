...
if (isset($_POST['id'])) {
    ...
    $query = "SELECT * FROM `tbl_listas` WHERE id = '$id_lista'";
    ...
    if (!empty($result)) {
        ...
        <div class="modal-header">
                ...
                <div class="modal-body">
                    <h3>Propuesta:</h3>
                        <p><?php echo $format1; ?></p>
                    <br>
                    <h3>Integrantes:</h3>
                        <?php 
                            $presidente_q = mysqli_query($conn, "SELECT `nombre`, `apellido` FROM `tbl_alumnos` WHERE dni = $presidente LIMIT 1;");
                            ...
                            $sec_admin_q = mysqli_query($conn, "SELECT `nombre`, `apellido` FROM `tbl_alumnos` WHERE dni = $sec_administracion LIMIT 1;");
                            ...
                            $sec_doc_q = mysqli_query($conn, "SELECT `nombre`, `apellido` FROM `tbl_alumnos` WHERE dni = $sec_documentacion LIMIT 1;");
                            ...
                            $tesorero_q = mysqli_query($conn, "SELECT `nombre`, `apellido` FROM `tbl_alumnos` WHERE dni = $tesorero LIMIT 1;");
                            ...
                            $vocal_prog_q = mysqli_query($conn, "SELECT `nombre`, `apellido` FROM `tbl_alumnos` WHERE dni = $vocal_programacion LIMIT 1;");
                            ...
                            $vocal_const_q = mysqli_query($conn, "SELECT `nombre`, `apellido` FROM `tbl_alumnos` WHERE dni = $vocal_construccion LIMIT 1;");
                            ...
                            $vocal_tur_q = mysqli_query($conn, "SELECT `nombre`, `apellido` FROM `tbl_alumnos` WHERE dni = $vocal_turismo LIMIT 1;");
                            ...
                            $vocal_cb1_q = mysqli_query($conn, "SELECT `nombre`, `apellido` FROM `tbl_alumnos` WHERE dni = $vocal_cicloBasico1 LIMIT 1;");
                            $vocal_cb1_data = mysqli_fetch_assoc($vocal_cb1_q);
                            
                            $vocal_cb2_q = mysqli_query($conn, "SELECT `nombre`, `apellido` FROM `tbl_alumnos` WHERE dni = $vocal_cicloBasico2 LIMIT 1;");
                            ...
                            $olimp_rep_q = mysqli_query($conn, "SELECT `nombre`, `apellido` FROM `tbl_alumnos` WHERE dni = $olimp_representante LIMIT 1;");
                            ...
                            $olimp_v1_q = mysqli_query($conn, "SELECT `nombre`, `apellido` FROM `tbl_alumnos` WHERE dni = $olimp_vocal1 LIMIT 1;");
                            $olimp_v1_data = mysqli_fetch_assoc($olimp_v1_q);
                            
                            $olimp_v2_q = mysqli_query($conn, "SELECT `nombre`, `apellido` FROM `tbl_alumnos` WHERE dni = $olimp_vocal2 LIMIT 1;");
                            ...
                            <?php
                            $prensa_rep_q = mysqli_query($conn, "SELECT `nombre`, `apellido` FROM `tbl_alumnos` WHERE dni = $prensa_representante LIMIT 1;");
                            ...
                            $prensa_v1_q = mysqli_query($conn, "SELECT `nombre`, `apellido` FROM `tbl_alumnos` WHERE dni = $prensa_vocal1 LIMIT 1;");
                            $prensa_v1_data = mysqli_fetch_assoc($prensa_v1_q);
                            
                            $prensa_v2_q = mysqli_query($conn, "SELECT `nombre`, `apellido` FROM `tbl_alumnos` WHERE dni = $prensa_vocal2 LIMIT 1;");
                            ...
                            $gyd_rep_q = mysqli_query($conn, "SELECT `nombre`, `apellido` FROM `tbl_alumnos` WHERE dni = $gyd_representante LIMIT 1;");
                            ...
                            $gyd_v1_q = mysqli_query($conn, "SELECT `nombre`, `apellido` FROM `tbl_alumnos` WHERE dni = $gyd_vocal1 LIMIT 1;");
                            $gyd_v1_data = mysqli_fetch_assoc($gyd_v1_q);
                            
                            $gyd_v2_q = mysqli_query($conn, "SELECT `nombre`, `apellido` FROM `tbl_alumnos` WHERE dni = $gyd_vocal2 LIMIT 1;");
