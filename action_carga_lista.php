...
$propuesta1 = mysqli_real_escape_string($conn, $_POST['propuesta1']);
$propuesta2 = mysqli_real_escape_string($conn, $_POST['propuesta2']);
$propuesta3 = mysqli_real_escape_string($conn, $_POST['propuesta3']);
...
if (empty($color) || empty($propuesta1) || empty($propuesta2) || empty($propuesta3) || empty($presidente) || empty($sec_administracion) || empty($sec_documentacion) || empty($tesorero) || empty($vocal_programacion) || empty($vocal_construccion) || empty($vocal_turismo) || empty($vocal_cicloBasico1) || empty($vocal_cicloBasico2) || empty($olimp_representante) || empty($olimp_vocal1) || empty($olimp_vocal2) || empty($eventos_representante) || empty($eventos_vocal1) || empty($eventos_vocal2) || empty($prensa_representante) || empty($prensa_vocal1) || empty($prensa_vocal2) || empty($gyd_representante) || empty($gyd_vocal1) || empty($gyd_vocal2) || empty($prof_acesor) || empty($prof_acesorsup)) {
